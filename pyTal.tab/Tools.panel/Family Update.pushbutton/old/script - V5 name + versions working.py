...
import os
from Autodesk.Revit.DB import OpenOptions, ModelPathUtils, StorageType
...
for family_file in family_files:
    ...
    if family_name in project_families:
        ...
        display_name = "{} (Project Version: {}, Folder Version: {})".format(family_name, project_version_str, file_version_str)
